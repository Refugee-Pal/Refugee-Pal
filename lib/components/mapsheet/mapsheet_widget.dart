                                        ...
                                        child: ClipOval(
                                          child: BackdropFilter(
                                            ...
                                            child: ToggleIcon(
                                              ...
                                              value: containerUserRecord.pinned!
                                                  .toList()
                                                  .contains(widget.doc!.name),
                                              onIcon: FaIcon(
                                                                      ...
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            final pinnedElement =
                                                                                columnProgramsRecord.name;
                                                                            final pinnedUpdate = containerUserRecord.pinned!.toList().contains(pinnedElement)
                                                                          ...
                                                                          value: containerUserRecord
                                                                              .pinned!
                                                                              .toList()
                                                                              .contains(columnProgramsRecord.name),
                                                                          onIcon:
                                                                              FaIcon(
                                                                            FontAwesomeIcons.mapPin,
                                                                            color:
                                                                    ...
                                                                    child: StreamBuilder<
                                                                      ...
                                                                      stream:
                                                                        ...
                                                                        queryBuilder: (userRecord) => userRecord.whereIn(
                                                                            'name',
                                                                            columnProgramsRecord.people!.toList()),
                                                                      ),
                                                                      builder:
                                                                          (context,
                                                                              snapshot) {
