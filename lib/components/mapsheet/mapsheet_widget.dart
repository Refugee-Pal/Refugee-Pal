                                              ...
                                              children: [
                                                StreamBuilder<
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    List<Translations4Record>
                                                        columnTranslations4RecordList =
                                                        snapshot.data!;
                                                    final columnTranslations4Record =
                                                        columnTranslations4RecordList
                                                                .isNotEmpty
                                                            ? columnTranslations4RecordList
                                                                .first
                                                              ...
                                                              child: StreamBuilder<
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  List<Translations3Record>
                                                                      ...
                                                                      snapshot
                                                                          .data!;
                                                                  final textTranslations3Record = textTranslations3RecordList
                                                                          .isNotEmpty
                                                                      ? textTranslations3RecordList
                                                                          .first
                                                                      : null;
                                                                  return Text(
                                                                    valueOrDefault<
                                                                        String>(
                                                                      (columnLanguagesRecord?.name != 'English') &&
                                                                              (valueOrDefault(currentUserDocument?.translateApp, '') ==
                                                                                  'true')
                                                                          ? textTranslations3Record
                                                                              ?.value
                                                                          : widget
                                                                              .doc
                                                                              ?.description,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            stream:
                                                                              ...
                                                                              queryBuilder: (organizationsRecord) => organizationsRecord.where(
                                                                                'name',
                                                                                isEqualTo: widget.doc?.organization,
                                                                              ),
                                                                              singleRecord: true,
                                                                            ),
                                                                            builder:
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              valueOrDefault<String>(
                                                                                (columnLanguagesRecord?.name != 'English') && (valueOrDefault(currentUserDocument?.translateApp, '') == 'true') ? columnTranslations4Record?.value : widget.doc?.organization,
                                                                                'no value',
                                                                              ),
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        0.0),
                                                            child: AutoSizeText(
                                                              'Other ${valueOrDefault<String>(
                                                                (columnLanguagesRecord?.name !=
                                                                            'English') &&
                                                                        (valueOrDefault(currentUserDocument?.translateApp, '') ==
                                                                            'true')
                                                                    ? columnTranslations4Record
                                                                        ?.value
                                                                    : widget.doc
                                                                        ?.organization,
                                                                'no value',
                                                                                  ...
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: StreamBuilder<List<Translations6Record>>(
                                                                                      stream: queryTranslations6Record(
                                                                                        parent: rowLocationsRecord.reference,
                                                                                        queryBuilder: (translations6Record) => translations6Record.where(
                                                                                          'language',
                                                                                          isEqualTo: columnLanguagesRecord?.code,
                                                                                        ),
                                                                                        singleRecord: true,
                                                                                      ),
                                                                                      builder: (context, snapshot) {
                                                                                        ...
                                                                                        final textTranslations6Record = textTranslations6RecordList.isNotEmpty ? textTranslations6RecordList.first : null;
                                                                                        return Text(
                                                                                          valueOrDefault<String>(
                                                                                            (columnLanguagesRecord?.name != 'English') && (valueOrDefault(currentUserDocument?.translateApp, '') == 'true') ? textTranslations6Record?.value : rowLocationsRecord.name,
                                                                                            'no value',
                                                                                          ),
                                                                                          style: FlutterFlowTheme.of(context).bodyMedium,
                                                                                        );
                                                                                ...
                                                                                Padding(
                                                                                  ...
                                                                                  child: StreamBuilder<List<CategoryRecord>>(
                                                                                    stream: queryCategoryRecord(
                                                                                      queryBuilder: (categoryRecord) => categoryRecord.whereIn('title', rowLocationsRecord.category),
                                                                                    ),
                                                                                    builder: (context, snapshot) {
                                                                                      // Customize what your widget looks like when it's loading.
                                                                                      if (!snapshot.hasData) {
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                            ...
                                                                            Align(
                                                                              ...
                                                                              child: ToggleIcon(
                                                                                onPressed: () async {
                                                                                  ...
                                                                                  final pinnedUpdate = containerUserRecord.pinned.contains(pinnedElement) ? FieldValue.arrayRemove([pinnedElement]) : FieldValue.arrayUnion([pinnedElement]);
                                                                                ...
                                                                                value: containerUserRecord.pinned.contains(columnProgramsRecord.name),
                                                                                onIcon: FaIcon(
                                                                                  FontAwesomeIcons.mapPin,
                                                                                  color: FlutterFlowTheme.of(context).primary,
                                                                                  size: 25.0,
                                                                        ...
                                                                        if (columnProgramsRecord.dates.length !=
                                                                            0)
                                                                          Padding(
                                                                            padding: EdgeInsetsDirectional.fromSTEB(
                                                                                0.0,
                                                                                  ...
                                                                                  child: RichText(
                                                                                    ...
                                                                                    text: TextSpan(
                                                                                      children: [
                                                                                        ...
                                                                                        TextSpan(
                                                                                          text: columnProgramsRecord.dates.length > 1 ? ' +${(columnProgramsRecord.dates.length - 1).toString()} dates' : '',
                                                                                          style: TextStyle(),
                                                                                          ...
                                                                                          recognizer: TapGestureRecognizer()
                                                                                            ..onTap = () async {
                                                                                              setState(() {
                                                                                                ...
                                                                                                _model.dateToShow = columnProgramsRecord.dates.toList().cast<DateTime>();
                                                                                              });
