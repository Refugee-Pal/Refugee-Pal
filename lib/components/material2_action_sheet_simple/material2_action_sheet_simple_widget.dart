...
class Material2ActionSheetSimpleWidget extends StatefulWidget {
  const Material2ActionSheetSimpleWidget({
    Key? key,
    required this.messageToLoad,
  }) : super(key: key);

  final MessagesRecord? messageToLoad;

  @override
  _Material2ActionSheetSimpleWidgetState createState() =>
    ...
    return Container(
      ...
      child: Stack(
        children: [
          if (!_model.isEditing!)
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(5.0, 20.0, 0.0, 30.0),
              child: Column(
                      ...
                      child: Container(
                        ...
                        child: StreamBuilder<MessagesRecord>(
                          stream: MessagesRecord.getDocument(
                              widget.messageToLoad!.reference),
                          builder: (context, snapshot) {
                            ...
                            final rowMessagesRecord = snapshot.data!;
                            return Row(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText: rowMessagesRecord.text,
