                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Builder(
                                                                          builder:
                                                                              (context) {
                                                                            final locations =
                                                                                (_model.showAll! ? blurLocationsRecordList : _model.simpleSearchResults4).toList();
                                                                            return SingleChildScrollView(
                                                                              scrollDirection: Axis.horizontal,
                                                                              child: Row(
                                                                                mainAxisSize: MainAxisSize.max,
                                                                        ...
                                                                        final pinned =
                                                                          ...
                                                                          if (_model.choiceChipsValue ==
                                                                            ...
                                                                            return stackUserRecord.recents!.toList();
                                                                              ...
                                                                              'Locations') {
                                                                            return (_model.showAll!
                                                                                ? blurLocationsRecordList.map((e) => e.name).withoutNulls.toList()
                                                                                : _model.simpleSearchResults4.map((e) => e.name).withoutNulls.toList());
                                                                          } else {
                                                                            return (_model.showAll!
                                                                                ? blurChatsRecordList.map((e) => e.name).withoutNulls.toList()
                                                                                : _model.simpleSearchResults3.map((e) => e.name).withoutNulls.toList());
                                                                          }
                                                                        }()
                                                                                .toList();
                                                                        return ListView
                                                                                          ...
                                                                                          child: Padding(
                                                                                            ...
                                                                                            child: InkWell(
                                                                                              ...
                                                                                              child: Column(
                                                                                                ...
                                                                                                children: [
                                                                                                  AutoSizeText(
                                                                                                    containerResourceproviderRecord!.name!,
                                                                                                    style: FlutterFlowTheme.of(context).titleLarge,
                                                                                                  ),
                                                                                                  Padding(
                                                                                                    padding: EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 0.0, 0.0),
                                                                                                    child: Text(
                                                                                                      containerResourceproviderRecord!.information!,
                                                                                                      style: FlutterFlowTheme.of(context).bodyMedium,
                                                                                                    ),
                                                                                                  ),
                                                                                                ],
