                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  return ListView
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      return Visibility(
                                                                        visible:
                                                                            (((listViewChatsRecord.type != 'QA') && !_model.isQA!) || ((listViewChatsRecord.type == 'QA') && _model.isQA!)) &&
                                                                                (listViewChatsRecord.users!.toList().contains(valueOrDefault(currentUserDocument?.name, '')) || (valueOrDefault(currentUserDocument?.isRefugee, '') == 'false')),
                                                                        child:
                                                                            Card(
                                                                          clipBehavior:
